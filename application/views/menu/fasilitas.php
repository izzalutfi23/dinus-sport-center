...
<div class="rooms" style="margin-top: 70px;">
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="section_title_container text-center magic_up">
					<div class="section_subtitle">Fasilitas</div>
					<div class="section_title"><h2>Udinus Sport Center</h2></div>
				</div>
			</div>
		</div>
		<div class="row room_row magic_up">
			...
			<div class="col-lg-4 room_col">
				<div class="room">
					<div class="room_image"><img src="<?=base_url()?>assets/images/room_1.jpg" alt="https://unsplash.com/@jonathan_percy"></div>
			...
			<div class="col-lg-4 room_col">
				<div class="room">
					<div class="room_image"><img src="<?=base_url()?>assets/images/room_2.jpg" alt="https://unsplash.com/@ultralinx"></div>
					<div class="room_content text-center">
						<div class="room_price">From $90 / <span>Night</span></div>
			...
			<div class="col-lg-4 room_col">
				<div class="room">
					<div class="room_image"><img src="<?=base_url()?>assets/images/room_3.jpg" alt="https://unsplash.com/@rhemakallianpur"></div>
					<div class="room_content text-center">
						<div class="room_price">From $90 / <span>Night</span></div>
						<div class="room_type">double</div>
						<div class="room_title"><a href="rooms.html">Deluxe Suite</a></div>
